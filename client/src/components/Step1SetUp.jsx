        ...
        transition={{duration:0.6}}
         className='min-h-screen flex items-center justify-center bg-gradient-to-br from-gray-100 to-gray-200 px-4'>
            ...
            <div className='w-full max-w-6xl bg-white rounded-3xl shadow-2xl grid md:grid-cols-2 overflow-hidden'>
                ...
                className='relative bg-gradient-to-br from-green-200 to-green-100 p-12 flex flex-col justify-center'>
                    <h2 className='text-4xl font-bold text-gray-800 mb-6'>Start Your AI Interview</h2>
                    <p className='text-gray-600 mb-10'>Practise real interview scenarios powered by AI. Improve communication, technical skills, and confidence.</p>
                ...
                className='p-12 bg-white'>
                    ...
                    <h2 className='text-3xl font-bold text-gray-800  mb-8'>Interview Set-up</h2>

                    <div className='space-y-6'>
                        <div className='relative'>
                            <FaUserTie className='absolute top-4 left-4 text-gray-400'/>
                            <input type='text' placeholder='Enter Role'
                            className='w-full pl-12 pr-4 py-3 border border-gray-200 rounded-xl focus:ring focus:ring-green-500 outline-none transition'
                                ...
                                {skills.length >0 && (
                                    <div>
                                        ...
                                        <div className='flex flex-wrap gap-2'>
                                            {skills.map((s,i)=>(
                                                <span key={i} className='bg-green-200 text-green-800 px-3 py-1 rounded-full text-sm'>{s}</span>
                                            ))}
                                        </div>
                                    </div>
                                )}
