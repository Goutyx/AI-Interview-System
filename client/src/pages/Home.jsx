    ...
    <div className='min-h-screen bg-[#f3f3f3] flex flex-col'>
      ...
      <div className='flex-1 px-6 py-20'>
        ...
        <div className='text-center mb-28'>
            ...
            className='text-grey-500 mt-6 max-w-2xl mx-auto text-lg'>
            ...
            <div className='grid md:grid-cols-2 gap-10'>
              {
                [
                  ...
                  },
                  {
                    ...
                    desc: "Detailed strengths, weakness and improvement"
                  },
                  {
                    image: analyticsImg,
                    icon: <BsBarChart size={20} />,
                  ...
                  <motion.div key={index}
                    ...
                    className='bg-white border border-gray-200 rounded-3xl p-8 shadow-sm hover:shadow-xl transition-all'>
                      <div className=' flex flex-col md:flex-row items-center gap-8'>
                        <div className='w-full mid:w-1/2 flex justify-center'>
                        ...
                        <h3 className='font semi-bold mb-3 text-xl'>{item.title}</h3>
