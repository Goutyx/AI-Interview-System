    ...
    try{
        ...
        const options = {
            ...
            handler:async function (response) {
                ...
                alert("Payment Successfull!! Credit added!!");
                navigate("/")
            },
  ...
  return (
    ...
    ${
      isSelected
        ...
        : "border-gray-200 bg-white shadow-md hover:border-emerald-500 hover:shadow-xl"
    }
...
`}
            >
              ...
              {plan.default && (
                <div className="absolute top-6 right-6 bg-gray-200 text-gray-700 text-xs px-3 py-1 rounded-full shadow">
                  Default
                </div>
              )}
